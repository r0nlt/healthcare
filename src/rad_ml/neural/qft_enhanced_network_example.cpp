 ...
 * @brief Example implementation of QFT-enhanced neural network functionality
 *
 * This file provides example code for using the QFT-enhanced neural network.
 */
...
// Explicit instantiation for the template functions we want to use from other files
                                   ...
                                   double training_duration, int test_iterations)
{
    ...
    ProtectedNeuralNetwork_mock<float> semiconductor_network(layer_sizes,
